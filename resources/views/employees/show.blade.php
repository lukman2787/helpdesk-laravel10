                        ...
                        <div class="profile-view">
                            <div class="profile-img-wrap">
                                <div class="profile-img">
                                    <a href="#"><img alt src="/img/profiles/{{ $profile->profile_picture ?? 'user_default.jpg' }}"></a>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            ...
                                            <small class="text-muted">{{ $profile->designation_name }}</small>
                                            <div class="staff-id">Employee ID : {{ $profile->employee_id }}</div>
                                            <div class="small doj text-muted">Date of Join : {{ $profile->employee_id }}</div>
                                    ...
                                    <div class="col-md-7">
                                        <ul class="personal-info">
                                            ...
                                            <li>
                                                ...
                                                <div class="text"><a href><span>{{ $profile->email }}</span></a></div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <div class="text">{{ $profile->address_id . ' Kab. ' . $profile->city . ' - ' . $profile->state }}</div>
                                            </li>
                                            <li>
                                                <div class="title">Gender:</div>
                                                <div class="text">{{ $profile->gender == 'M' ? 'Male' : 'Female' }}</div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="text">
                                                    ...
                                                    <a href="{{ url('employee') . '/' . $profile->reports_to }}">
                                                        {{ $profile->reports_to }}
                                                    </a>
                                                </div>
                                            </li>
