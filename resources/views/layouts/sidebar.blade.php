        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <nav class="greedys sidebar-horizantal">
                <ul class="list-inline-item list-unstyled links">
                    ...
                    <li><a href="{{ url('/home') }}"><i class="la la-dashboard"></i> <span>Home</span></a></li>
                    <li class="menu-title">
                        <span>Employees</span>
                    </li>
                    <li class="submenu">
            ...
            <ul class="sidebar-vertical">
                @if (auth()->user()->hasRole(['Admin', 'Manager', 'Admin HR']))
                    <li class="menu-title">
                        <span>Main</span>
                    </li>
                    <li class="submenu">
                        ...
                        <ul style="display: none">
                            ...
                            <li>
                                <a href="{{ url('/home') }}">Employee Dashboard</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-title">
                ...
                @endif
                @if (auth()->user()->hasRole(['Admin', 'Manager', 'Teknisi', 'Admin HR']))
                    <li><a href="{{ url('tickets') }}"><i class="la la-ticket"></i> <span>Tickets</span></a></li>
                    <li class="menu-title">
                        <span>Setting</span>
                    </li>
                    <li><a href="{{ url('users') }}"><i class="la la-user-plus"></i> <span>Users</span></a></li>
                    <li><a href="{{ url('roles') }}"><i class="la la-columns"></i> <span>Roles & Permissions</span></a></li>
                @endif
                ...
                @if (Auth::user()->hasRole('Employee'))
                    ...
                    <li><a href="{{ url('home') }}"><i class="la la-dashboard"></i> <span>Home</span></a></li>
                    <li><a href="{{ url('support/myticket') }}"><i class="la la-ticket"></i> <span>My Tickets</span></a></li>
                @endif
            </ul>
        </div>
    </div>
    ...
    <div class="sidebar sidebar-twocol">
        <div class="sidebar-left slimscroll">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link active" id="v-pills-pages-tab" title="Pages" data-bs-toggle="pill" href="#v-pills-pages" role="tab" aria-controls="v-pills-pages" aria-selected="false">
