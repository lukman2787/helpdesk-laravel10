            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Form Add</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control @error('location_name') is-invalid @enderror" type="text" name="location_name" value="{{ old('location_name') }}">
                                            @error('location_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control @error('address_1') is-invalid @enderror" name="address_1" value="{{ old('addfress_1') }}">
                                            @error('address_1')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
