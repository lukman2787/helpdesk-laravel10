...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('support/filter-mytickets', [TicketController::class, 'fetchMyticket'])->name('mytickets.filter');
    Route::put('support/closed-myticket/{id}', [TicketController::class, 'ticket_completed'])->name('myticket.completed');
    Route::put('support/reopen-myticket/{id}', [TicketController::class, 'ticket_reopened'])->name('myticket.reopened');
